// Assignment #8: write a JavaScript program to take input string from user and 
// count the number of times a alphabet is repeated in the string and then print it
//  on the screen.

// for e.g. if the input string is - prasad

// Your o/p should be like below -
...
let aCount = 0, bCount = 0, cCount = 0, dCount = 0, eCount = 0, fCount = 0, gCount = 0,
...
vCount = 0, wCount = 0, xCount = 0, yCount = 0, zCount = 0;
...
if(str){
    ...
    document.write("<marquee behavior='slide' scrollAmount='500'><h1>Entered String : " + str + "</h1></marquee>");
    ...
    if(dCount) document.write("<p> d : " + dCount + "</p>");
